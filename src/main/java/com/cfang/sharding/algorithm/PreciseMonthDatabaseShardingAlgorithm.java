 ...
 * @description
 */
public class PreciseMonthDatabaseShardingAlgorithm implements PreciseShardingAlgorithm<String> {
    ...
    public String doSharding(Collection<String> collection, PreciseShardingValue<String> preciseShardingValue) {
        ...
        for (String item : collection) {
            String month = DateUtil.month(DateUtil.parse(columnVal)) + 1 + "";
            if (item.endsWith("_" + month)){
                return item;
            }
        }
        return null;
